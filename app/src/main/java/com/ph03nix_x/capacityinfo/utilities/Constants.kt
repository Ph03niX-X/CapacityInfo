...
object Constants {
    ...
    const val IMPORT_HISTORY_REQUEST_CODE = 1
    ...
    const val FULL_CHARGE_REMINDER_JOB_SERVICE_JOB_PERIODIC = 30L * 60L * 1000L
    const val CHECK_PREMIUM_JOB_SERVICE_PERIODIC = 8L * 60L * 60L * 1000L
}