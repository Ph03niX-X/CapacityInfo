...
object Constants {
    ...
    const val BATTERY_IS_FULLY_CHARGED_CHANEL_ID = "battery_fully_charged_channel"
    const val BATTERY_IS_CHARGED_CHANEL_ID = "battery_is_charged_channel"
    const val BATTERY_IS_DISCHARGED_CHANEL_ID = "battery_is_low_channel"
