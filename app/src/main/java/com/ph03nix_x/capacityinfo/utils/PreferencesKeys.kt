...
object PreferencesKeys {
    ...
    const val IS_SHOW_CHARGING_TIME_IN_APP = "is_show_charging_time_in_app"
    const val IS_SHOW_LAST_CHARGE_TIME_IN_APP = "is_show_last_charge_time_in_app"
    const val IS_SHOW_CAPACITY_ADDED_IN_APP = "is_show_capacity_added_in_app"
    const val IS_SHOW_CAPACITY_ADDED_LAST_CHARGE_IN_APP = "is_show_capacity_added_last_charge_in_app"
